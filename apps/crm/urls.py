...
urlpatterns = [
    ...
    path('apply-discount', views.ApplyInstallerDiscountView.as_view(), name='apply_installer_discount'),
    path('qr/<int:qr_type>/', views.installer_qr_code, name='installer_qr_code'),
