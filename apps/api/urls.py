...
urlpatterns = [
    ...
    path('purchases/history/', views.PurchaseHistoryAPIView.as_view(), name='api_purchase_history'),
    path('purchase/return/', views.PurchaseReturnAPIView.as_view(), name='api_purchase_return'),
